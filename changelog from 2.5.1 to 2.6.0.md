...
> * FastCraft
> * MalisisCore
# Updated AE2FluidCraft-Rework (1.1.74-gtnh@Side.BOTH --> 1.2.28-gtnh@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/AE2FluidCraft-Rework/compare/1.1.73-gtnh...1.2.28-gtnh
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/AFSU/compare/1.2.6-GTNH...1.3.0-GTNH
>## What's Changed
> * [bs] update spotless, clean repos by @bombcar in https://github.com/GTNewHorizons/AFSU/pull/6 (1.3.0-GTNH)
>

# Updated AdventureBackpack2 (1.0.17-GTNH@Side.BOTH --> 1.1.3-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/AdventureBackpack2/compare/1.0.16-GTNH...1.1.3-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/AlchemyGrate/compare/1.0.3-GTNH...1.1.0-GTNH

# Updated Amazing-Trophies (1.1.4@Side.BOTH --> 1.2.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Amazing-Trophies/compare/1.1.4...1.2.1
>## What's Changed
...
# New Mod - Angelica (1.0.0-alpha40@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Angelica/commits/1.0.0-alpha40
>## What's Changed
...
> * Only disable holoinventory when hudcaching is enabled by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/440 (1.0.0-alpha39)
> * Thread safe ISBRH compatibility with Extra Utilities 2 by @Cleptomania in https://github.com/GTNewHorizons/Angelica/pull/439 (1.0.0-alpha39)
> * Fix NotFine Twilight Forest compat mixins builder by @jss2a98aj in https://github.com/GTNewHorizons/Angelica/pull/430 (1.0.0-alpha38)
> * Fix flickering of HoloInventory and Xaero's Map Waypoints by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/418 (1.0.0-alpha37)
> * Check if hudcaching is enabled before removing xaeros ASM by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/419 (1.0.0-alpha37)
> * Add more methods present in modern MatrixStack by @wahfl2 in https://github.com/GTNewHorizons/Angelica/pull/420 (1.0.0-alpha37)
> * Fix render distance being capped at 20 by @MellowArpeggiation in https://github.com/GTNewHorizons/Angelica/pull/428 (1.0.0-alpha37)
> * Sync NotFine by @jss2a98aj in https://github.com/GTNewHorizons/Angelica/pull/427 (1.0.0-alpha37)
...
> * Don't blacklist gregtech from the render thread by @mitchej123 in https://github.com/GTNewHorizons/Angelica/pull/356 (1.0.0-alpha34)
> * Update priority of FOV multiplier event by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/361 (1.0.0-alpha34)
> * Potential fix for splash screen crashes by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/363 (1.0.0-alpha34)
> * Initialize toggle keybind when registering by @Caedis in https://github.com/GTNewHorizons/Angelica/pull/366 (1.0.0-alpha34)
...
**Full Changelog**: https://github.com/GTNewHorizons/AngerMod/compare/0.6.3...0.7.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/AppleCore/compare/3.2.12...3.3.0

# Updated Applied-Energistics-2-Unofficial (rv3-beta-292-GTNH@Side.BOTH --> rv3-beta-352-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/compare/rv3-beta-291-GTNH...rv3-beta-352-GTNH
>## What's Changed
> * Notify the ME network on set orientation by @ghostflyby in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/511 (rv3-beta-352-GTNH)
> * Add null check to Drive rendering by @Caedis in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/510 (rv3-beta-351-GTNH)
...
> * Show names of renamed blocks in WAILA. by @AbdielKavash in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/503 (rv3-beta-348-GTNH)
> * bandaid fix for shift mode lag by @Glease in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/502 (rv3-beta-348-GTNH)
...
> * Remove three unwanted recipes by @chochem in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/492 (rv3-beta-343-GTNH)
...
> * Add tall style cpu table for crafting confirm gui by @MCTBL in https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/pull/490 (rv3-beta-339-GTNH)
...
# Updated ArchitectureCraft (1.8.6@Side.BOTH --> 1.9.5@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ArchitectureCraft/compare/1.8.6...1.9.5
>## What's Changed
> * Sawbench Improvements/Fixes, and Additional Shapes by @Superfrogman98 in https://github.com/GTNewHorizons/ArchitectureCraft/pull/18 (1.9.5)
...
**Full Changelog**: https://github.com/GTNewHorizons/AsieLib/compare/0.5.4...0.5.5

# Updated Avaritia (1.46@Side.BOTH --> 1.49@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Avaritia/compare/1.46...1.49
>## What's Changed
...
# Updated Avaritiaddons (1.6.0-GTNH@Side.BOTH --> 1.7.1-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Avaritiaddons/compare/1.6.0-GTNH...1.7.1-GTNH
>## What's Changed
> * Fix infinity chest merges items with different durability  by @HoleFish in https://github.com/GTNewHorizons/Avaritiaddons/pull/11 (1.7.1-GTNH)
>

# Updated Battlegear2 (1.3.0@Side.BOTH --> 1.3.7@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Battlegear2/compare/1.3.0...1.3.7
>## What's Changed
> * fix mystery arrows giving diamonds on player hit by @kyoi-the-fox in https://github.com/GTNewHorizons/Battlegear2/pull/27 (1.3.7)
...
**Full Changelog**: https://github.com/GTNewHorizons/Baubles/compare/1.0.3...1.0.4
...
**Full Changelog**: https://github.com/GTNewHorizons/BetterAchievements/compare/0.1.3...0.2.0

# Updated BetterBuildersWands (0.10.1-GTNH@Side.BOTH --> 0.11.1-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BetterBuildersWands/compare/0.10.1-GTNH...0.11.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/BetterCrashes/compare/1.3.5-GTNH...1.4.0-GTNH

# Updated BetterLoadingScreen (1.5.3-GTNH@Side.CLIENT --> 1.6.1-GTNH@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/BetterLoadingScreen/compare/1.5.3-GTNH...1.6.1-GTNH
>## What's Changed
> * Add LANG files for BLS. Some are "missing". by @IcaroKaue in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/23 (1.6.1-GTNH)
> * Allow to work with txloader by @miozune in https://github.com/GTNewHorizons/BetterLoadingScreen/pull/24 (1.6.1-GTNH)
>

# Updated BetterP2P (1.1.20@Side.BOTH --> 1.2.1@Side.BOTH)
...
# Updated BetterQuesting (3.4.7-GTNH@Side.BOTH --> 3.5.13-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BetterQuesting/compare/3.4.6-GTNH...3.5.13-GTNH
>## What's Changed
> * add gui to select image on local disk by @Glease in https://github.com/GTNewHorizons/BetterQuesting/pull/135 (3.5.13-GTNH)
> * Make searched quests more noticeable by @Lyfts in https://github.com/GTNewHorizons/BetterQuesting/pull/134 (3.5.10-GTNH)
> * cache update in RewardQuestCompletion by @Pa4ok in https://github.com/GTNewHorizons/BetterQuesting/pull/132 (3.5.9-GTNH)
> * embed images by @Glease in https://github.com/GTNewHorizons/BetterQuesting/pull/130 (3.5.9-GTNH)
...
# Updated Binnie (2.2.4@Side.BOTH --> 2.3.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Binnie/compare/2.2.4...2.3.4
>## What's Changed
...
# Updated BloodArsenal (1.2.11@Side.BOTH --> 1.3.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BloodArsenal/compare/1.2.11...1.3.2
>## What's Changed
> * add nullcheck to Enchant ritual lp requirement message to avoid crash… by @kyoi-the-fox in https://github.com/GTNewHorizons/BloodArsenal/pull/23 (1.3.2)
> * add null checks for all sendPlayerInformation cases,to avoid crashes … by @kyoi-the-fox in https://github.com/GTNewHorizons/BloodArsenal/pull/24 (1.3.2)
...
# Updated BloodMagic (1.4.3@Side.BOTH --> 1.5.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BloodMagic/compare/1.4.3...1.5.2
>## What's Changed
...
# Updated Botania (1.10.3-GTNH@Side.BOTH --> 1.10.12-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Botania/compare/1.10.3-GTNH...1.10.12-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Botanic-horizons/compare/1.0.19-GTNH...1.1.2-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/BugTorch/compare/1.2.12-GTNH...1.2.13-GTNH

# Updated BuildCraft (7.1.38@Side.BOTH --> 7.1.39@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BuildCraft/compare/7.1.38...7.1.39

# Updated BuildCraftCompat (7.1.16@Side.BOTH --> 7.1.17@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BuildCraftCompat/compare/7.1.16...7.1.17

# Updated BuildCraftOilTweak (1.0.4@Side.BOTH --> 1.1.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/BuildCraftOilTweak/compare/1.0.4...1.1.1
>## What's Changed
> * Fix Version Replacement by @glowredman in https://github.com/GTNewHorizons/BuildCraftOilTweak/pull/2 (1.1.1)
>

# Updated CarpentersBlocks (3.4.1-GTNH@Side.BOTH --> 3.5.3-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/CarpentersBlocks/compare/3.4.1-GTNH...3.5.3-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Catwalks-2/compare/2.1.4-GTNH...2.2.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Chisel/compare/2.12.3-GTNH...2.14.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/CodeChickenCore/compare/1.1.12...1.2.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/CodeChickenLib/compare/1.1.10...1.2.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Computronics/compare/1.7.1-GTNH...1.7.2-GTNH

# Updated Controlling (2.0.1@Side.CLIENT --> 2.0.2@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Controlling/compare/2.0.1...2.0.2

# Updated CookingForBlockheads (1.2.16-GTNH@Side.BOTH --> 1.3.4-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/CookingForBlockheads/compare/1.2.16-GTNH...1.3.4-GTNH
>## What's Changed
> * Compatibility with old versions of Spice of Life by @Midnight145 in https://github.com/GTNewHorizons/CookingForBlockheads/pull/44 (1.3.4-GTNH)
...
**Full Changelog**: https://github.com/GTNewHorizons/CraftTweaker/compare/3.2.13...3.3.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/CreativeCore/compare/1.3.31-GTNH...1.4.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/CropLoadCore/compare/0.1.10...0.2.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/CropLoadCore/pull/9 (0.2.0)
>

# Updated Crops-plus-plus (1.5.12@Side.BOTH --> 1.6.5@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Crops-plus-plus/compare/1.5.12...1.6.5
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Custom-Main-Menu/compare/1.10.3...1.11.2
>## What's Changed
> * Make the mod info header readable by @ColonelGerdauf in https://github.com/GTNewHorizons/Custom-Main-Menu/pull/8 (1.11.2)
> * Cleanup by @miozune in https://github.com/GTNewHorizons/Custom-Main-Menu/pull/6 (1.11.1)
> * Fix translations not being reloaded on language change by @miozune in https://github.com/GTNewHorizons/Custom-Main-Menu/pull/7 (1.11.1)
>

# Updated Default-Configs (1.1.6@Side.CLIENT --> 1.2.0@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Default-Configs/compare/1.1.6...1.2.0

# Updated DefaultServerList (1.4.0@Side.CLIENT --> 1.5.0@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/DefaultServerList/compare/1.4.0...1.5.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/DefaultWorldGenerator/compare/0.2...0.3.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/DetravScannerMod/compare/1.7.2...1.8.0

# Updated Draconic-Evolution (1.2.1-GTNH@Side.BOTH --> 1.3.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Draconic-Evolution/compare/1.2.1-GTNH...1.3.5-GTNH
>## What's Changed
> * Add a dimension whitelist setting for draconic ore by @eigenraven in https://github.com/GTNewHorizons/Draconic-Evolution/pull/48 (1.3.5-GTNH)
...
**Full Changelog**: https://github.com/GTNewHorizons/DummyCore/compare/1.17.0...1.18.0

# Updated DuraDisplay (1.1.7@Side.CLIENT --> 1.2.3@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/DuraDisplay/compare/1.1.7...1.2.3
>## What's Changed
> * Fix showing unnecessary info on some items by @ghostflyby in https://github.com/GTNewHorizons/DuraDisplay/pull/17 (1.2.3)
> * Convert to foreach over stream by @Caedis in https://github.com/GTNewHorizons/DuraDisplay/pull/16 (1.2.2)
>

# Updated Electro-Magic-Tools (1.3.8@Side.BOTH --> 1.4.6@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Electro-Magic-Tools/compare/1.3.8...1.4.6
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/EnderCore/compare/0.2.18...0.4.6
>## What's Changed
...
# Updated EnderIO (2.5.9@Side.BOTH --> 2.7.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/EnderIO/compare/2.5.8...2.7.4
>## What's Changed
> * Improve FarmingStation portal texture rendering by @PT400C in https://github.com/GTNewHorizons/EnderIO/pull/157 (2.7.4)
...
# Updated EnderStorage (1.4.12@Side.BOTH --> 1.5.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/EnderStorage/compare/1.4.12...1.5.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/EnderZoo/compare/1.0.23...1.1.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/EnhancedLootBags/compare/1.1.0...1.1.1

# Updated Eternal-Singularity (1.1.2@Side.BOTH --> 1.2.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Eternal-Singularity/compare/1.1.2...1.2.1
>## What's Changed
> * Minor Cleanup by @glowredman in https://github.com/GTNewHorizons/Eternal-Singularity/pull/10 (1.2.1)
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/Eternal-Singularity/pull/9 (1.2.0)
>

# Updated FindIt (1.1.0@Side.BOTH --> 1.2.5@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/FindIt/compare/1.1.0...1.2.5
>## What's Changed
> * Rotate to Near Block by @slprime in https://github.com/GTNewHorizons/FindIt/pull/14 (1.2.5)
...
**Full Changelog**: https://github.com/GTNewHorizons/ForbiddenMagic/compare/0.6.7-GTNH...0.7.0-GTNH
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/ForbiddenMagic/pull/13 (0.7.0-GTNH)
>

# Updated ForestryMC (4.7.1@Side.BOTH --> 4.8.9@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ForestryMC/compare/4.7.0...4.8.9
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ForgeMultipart/compare/1.4.1...1.4.8
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ForgeRelocation/compare/0.0.3...0.1.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ForgeRelocationFMP/compare/0.0.4...0.1.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Forgelin/compare/1.9.7-GTNH...1.9.9-GTNH
>## What's Changed
> * Add Annotations to Coremod Class by @glowredman in https://github.com/GTNewHorizons/Forgelin/pull/9 (1.9.9-GTNH)
>

# Updated GT5-Unofficial (5.09.44.110@Side.BOTH --> 5.09.45.163@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GT5-Unofficial/compare/5.09.44.107...5.09.45.163
>## What's Changed
...
> * Fix phased gold to vibrant alloy replacement by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2553 (5.09.45.132)
> * Disable unused hot black steel by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2554 (5.09.45.132)
...
> * Buff salt byproduct in Polyphenylene Sulfide line by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2542 (5.09.45.118-pre)
> * Fusion reactor UI fix by @AbdielKavash in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2543 (5.09.45.116)
> * Fix typo in kevlar tooltips by @NotAPenguin0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2541 (5.09.45.115-pre)
> * Fix typo in kevlar tooltips by @NotAPenguin0 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2541 (5.09.45.114)
...
> * fix wrench not rotating blocks on server side by @ghostflyby in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2525 (5.09.45.100)
> * Add alternative recipes for superconductors using molten spacetime by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2533 (5.09.45.100)
> * Fix OC calculator gets too much EUt consumption when limitOverclocks=true by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2529 (5.09.45.100)
> * Fix Fusion overclock by @HoleFish in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2528 (5.09.45.100)
> * Add requireMods for recipe builder by @miozune in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2417 (5.09.45.98-pre)
> * Add requireMods for recipe builder by @miozune in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2417 (5.09.45.97)
...
**Full Changelog**: https://github.com/GTNewHorizons/GTNEIOrePlugin/compare/1.1.3...1.2.0

# Updated GTNH-Intergalactic (1.2.9@Side.BOTH --> 1.3.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTNH-Intergalactic/compare/1.2.8...1.3.4
>## What's Changed
> * Shader-based space elevator cable renderer by @eigenraven in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/59 (1.3.3)
> * Avoid a bazillion verts all at once by @mitchej123 in https://github.com/GTNewHorizons/GTNH-Intergalactic/pull/57 (1.3.2)
...
# Updated GTNH-Lanthanides (0.11.9@Side.BOTH --> 0.12.12@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTNH-Lanthanides/compare/0.11.8...0.12.12
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/GTNH-TC-Wands/compare/1.3.1...1.4.0
>## What's Changed
> * Fix broken mod by @chochem in https://github.com/GTNewHorizons/GTNH-TC-Wands/pull/17 (1.4.0)
>

# Updated GTNHLib (0.0.13@Side.BOTH --> 0.2.11@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTNHLib/compare/0.0.13...0.2.11
>## What's Changed
> * Add suffixes 's' for stacks and 'i' for ingots of fluid to MathExpressionParser. by @AbdielKavash in https://github.com/GTNewHorizons/GTNHLib/pull/38 (0.2.11)
...
# Updated GTplusplus (1.10.54@Side.BOTH --> 1.11.58@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTplusplus/compare/1.10.54...1.11.58
>## What's Changed
> * Fix Waila for steam multis by @chochem in https://github.com/GTNewHorizons/GTplusplus/pull/876 (1.11.58)
> * Fix steam multi bonuses and document them by @chochem in https://github.com/GTNewHorizons/GTplusplus/pull/875 (1.11.58)
...
> * Fix Thermal Boiler accepting energy hatches. by @AbdielKavash in https://github.com/GTNewHorizons/GTplusplus/pull/872 (1.11.56)
> * Remove unwanted trivial cbd recipe by @chochem in https://github.com/GTNewHorizons/GTplusplus/pull/870 (1.11.55)
> * Allow wire cutter to toggle batch mode on MABS by @NotAPenguin0 in https://github.com/GTNewHorizons/GTplusplus/pull/868 (1.11.54)
> * Fix recipe loop. by @AbdielKavash in https://github.com/GTNewHorizons/GTplusplus/pull/866 (1.11.53)
> * Fix Boldarnator tooltip. by @AbdielKavash in https://github.com/GTNewHorizons/GTplusplus/pull/865 (1.11.53)
...
> * add amps in hatch in one go by @boubou19 in https://github.com/GTNewHorizons/GTplusplus/pull/851 (1.11.42)
...
> * Align fish centrifuge recipes with GT by @chochem in https://github.com/GTNewHorizons/GTplusplus/pull/845 (1.11.34-pre)
...
**Full Changelog**: https://github.com/GTNewHorizons/Gadomancy/compare/1.2.0...1.3.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/GalacticGregGT5/compare/1.0.10...1.1.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/GalacticGregGT5/pull/17 (1.1.0)
>

# Updated Galacticraft (3.0.75-GTNH@Side.BOTH --> 3.1.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Galacticraft/compare/3.0.74-GTNH...3.1.5-GTNH
>## What's Changed
...
# Updated Galaxy-Space-GTNH (1.2.15-GTNH@Side.BOTH --> 1.1.83-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Galaxy-Space-GTNH/commits/1.2.15-GTNH@Side.BOTH...1.1.83-GTNH@Side.BOTH

# Updated GigaGramFab (0.3.9@Side.BOTH --> 0.3.19@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GigaGramFab/compare/0.3.9...0.3.19
>## What's Changed
> * Fix AAL crashing by @HoleFish in https://github.com/GTNewHorizons/GigaGramFab/pull/37 (0.3.19)
> * Fix AAL batch mode duping fluid on last batch in rare cases. by @NotAPenguin0 in https://github.com/GTNewHorizons/GigaGramFab/pull/36 (0.3.17)
...
# Updated GoodGenerator (0.7.17@Side.BOTH --> 0.8.22@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GoodGenerator/compare/0.7.16...0.8.22
>## What's Changed
...
> * Fix naq fuel refinery coils not auto placeable in survival by @Lyfts in https://github.com/GTNewHorizons/GoodGenerator/pull/245 (0.8.15)
...
**Full Changelog**: https://github.com/GTNewHorizons/Gravitation-Suite-Neo/compare/1.0.20...1.1.5
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Hardcore-Ender-Expansion/compare/1.9.7-GTNH...1.10.1-GTNH
>## What's Changed
...
# Updated Hodgepodge (2.3.41@Side.BOTH --> 2.4.43@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Hodgepodge/compare/2.3.40...2.4.43
>## What's Changed
...
> * Add workaround for removed CoFH TE cache by @glowredman in https://github.com/GTNewHorizons/Hodgepodge/pull/349 (2.4.40)
> * Fix IC2 not loading translations from resource packs by @miozune in https://github.com/GTNewHorizons/Hodgepodge/pull/350 (2.4.40)
> * Fix bogus FMLProxyPacket NPEs on integrated server crashes by @eigenraven in https://github.com/GTNewHorizons/Hodgepodge/pull/351 (2.4.40)
> * Fix VoxelMap modID by @glowredman in https://github.com/GTNewHorizons/Hodgepodge/pull/348 (2.4.39)
...
# Updated HoloInventory (2.3.2-GTNH@Side.BOTH --> 2.4.7-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/HoloInventory/compare/2.3.2-GTNH...2.4.7-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/HydroEnergy/compare/1.1.1...1.2.0

# Updated IFU (1.9.6@Side.BOTH --> 1.10.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/IFU/compare/1.9.6...1.10.2
>## What's Changed
> * Add i18n code by @ArtherCasan in https://github.com/GTNewHorizons/IFU/pull/17 (1.10.2)
...
**Full Changelog**: https://github.com/GTNewHorizons/INpureCore/compare/1.1.5-GTNH...1.2.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/IguanaTweaksTConstruct/compare/2.3.0...2.4.1
>## What's Changed
...
# Updated InGame-Info-XML (2.8.5@Side.CLIENT --> 2.8.8@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/InGame-Info-XML/compare/2.8.5...2.8.8
>## What's Changed
> * Locale-aware config files by @miozune in https://github.com/GTNewHorizons/InGame-Info-XML/pull/20 (2.8.7)
>

# Updated Infernal-Mobs (1.7.9-GTNH@Side.BOTH --> 1.8.1-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Infernal-Mobs/compare/1.7.9-GTNH...1.8.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/IronChestMinecarts/compare/1.0.8...1.1.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Irontanks/compare/1.2.6...1.3.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/Irontanks/pull/13 (1.3.0)
>

# Updated Jabba (1.3.1@Side.BOTH --> 1.3.3@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Jabba/compare/1.3.1...1.3.3
>## What's Changed
...
# Updated KekzTech (0.9.6@Side.BOTH --> 0.10.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/KekzTech/compare/0.9.6...0.10.4
>## What's Changed
> * LSC readout Time to empty/full with seconds/mins/days/years by @Reflex18 in https://github.com/GTNewHorizons/KekzTech/pull/86 (0.10.4)
> * Added a time to empty/time to full readout on the LSC by @Reflex18 in https://github.com/GTNewHorizons/KekzTech/pull/85 (0.10.3)
...
# Updated KubaTech (0.13.12@Side.BOTH --> 0.14.7@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/KubaTech/compare/0.13.11...0.14.7
>## What's Changed
> * Fix gui for Mega Apiary and greenhouse by @Quetz4l in https://github.com/GTNewHorizons/KubaTech/pull/121 (0.14.7)
...
**Full Changelog**: https://github.com/GTNewHorizons/LittleTiles/compare/1.2.9-GTNH...1.3.0-GTNH

# Updated LogisticsPipes (1.0.8-GTNH@Side.BOTH --> 1.1.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/LogisticsPipes/compare/1.0.8-GTNH...1.1.5-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/LootGames/compare/2.0.8...2.1.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/LunatriusCore/compare/1.1.7-GTNH...1.2.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/MX-Random/compare/0.2.0...0.3.0
>## What's Changed
> * [bs] fix buildscripts for jenkins by @bombcar in https://github.com/GTNewHorizons/MX-Random/pull/7 (0.3.0)
>

# Updated MagicBees (2.7.1-GTNH@Side.BOTH --> 2.7.15-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/MagicBees/compare/2.7.1-GTNH...2.7.15-GTNH
>## What's Changed
...
# Updated MalisisDoors (1.14.0-GTNH@Side.BOTH --> 1.16.4-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/MalisisDoors/compare/1.14.0-GTNH...1.16.4-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Mantle/compare/0.3.7...0.4.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Minecraft-Backpack-Mod/compare/2.2.12-GTNH...2.3.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Minetweaker-Gregtech-5-Addon/compare/2.0.5...2.1.0

# Updated Mobs-Info (0.1.13-GTNH@Side.BOTH --> 0.2.6-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Mobs-Info/compare/0.1.12-GTNH...0.2.6-GTNH

# Updated ModTweaker (0.9.10@Side.BOTH --> 0.10.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ModTweaker/compare/0.9.10...0.10.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ModularUI/compare/1.1.24...1.1.42
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/MouseTweaks/compare/2.4.9-GTNH...2.4.17-GTNH
>## What's Changed
...
# Updated MrTJPCore (1.1.5@Side.BOTH --> 1.1.7@Side.BOTH)
...
**Full Changelog**: https://github.com/GTNewHorizons/NEI-Integration/compare/1.3.3...1.4.0
>## What's Changed
> * [bs] fix buildscripts for jenkins by @bombcar in https://github.com/GTNewHorizons/NEI-Integration/pull/9 (1.4.0)
>

# Updated Natura (2.5.7@Side.BOTH --> 2.6.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Natura/compare/2.5.7...2.6.1
>## What's Changed
> * Register Natura Saplings individually by @kyoi-the-fox in https://github.com/GTNewHorizons/Natura/pull/18 (2.6.1)
>

# Updated NaturesCompass (1.3.6-GTNH@Side.BOTH --> 1.4.0-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NaturesCompass/compare/1.3.6-GTNH...1.4.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/NetherPortalFix/compare/1.1.2...1.2.0

# Updated NewHorizonsCoreMod (2.2.55@Side.BOTH --> 2.3.50@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NewHorizonsCoreMod/compare/2.2.53...2.3.50
>## What's Changed
...
> * Remove duplicate TF portal gen recipe by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/832 (2.3.44)
...
> * Rename with new TF changes by @Caedis in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/820 (2.3.41-pre)
> * Fix apimancer typo in recipe and removal by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/821 (2.3.41-pre)
> * Fix new TF door recipes by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/822 (2.3.41-pre)
> * Fix broken tinkers defence recipes by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/823 (2.3.41-pre)
> * Rename with new TF changes by @Caedis in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/820 (2.3.40)
> * Fix apimancer typo in recipe and removal by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/821 (2.3.40)
> * Fix new TF door recipes by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/822 (2.3.40)
> * Fix broken tinkers defence recipes by @chochem in https://github.com/GTNewHorizons/NewHorizonsCoreMod/pull/823 (2.3.40)
...
**Full Changelog**: https://github.com/GTNewHorizons/Nodal-Mechanics/compare/1.1.-6-GTNH...1.2.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughEnergistics/compare/1.4.6...1.5.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughIds/compare/1.5.3...2.0.3
>## What's Changed
...
# Updated NotEnoughItems (2.4.13-GTNH@Side.BOTH --> 2.5.27-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughItems/compare/2.4.13-GTNH...2.5.27-GTNH
>## What's Changed
...
> * Adjust readability and padding of item panel footer size by @Caedis in https://github.com/GTNewHorizons/NotEnoughItems/pull/470 (2.5.25-GTNH)
> * Update icon for #451 by @MalTeeez in https://github.com/GTNewHorizons/NotEnoughItems/pull/471 (2.5.25-GTNH)
...
# Updated Nuclear-Control (2.5.1@Side.BOTH --> 2.6.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Nuclear-Control/compare/2.5.0...2.6.2
>## What's Changed
...
# Updated Nutrition (0.0.5@Side.BOTH --> 0.0.10@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Nutrition/compare/0.0.5...0.0.10
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OCGlasses/compare/1.4.2-GTNH...1.5.0-GTNH
...
# Updated OpenComputers (1.9.21-GTNH@Side.BOTH --> 1.10.11-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/OpenComputers/compare/1.9.19-GTNH...1.10.11-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OpenModsLib/compare/0.10.6...0.10.9
>## What's Changed
...
# Updated OpenModularTurrets (2.2.11-247@Side.BOTH --> 2.3.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/OpenModularTurrets/compare/2.2.11-247...2.3.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OpenPrinter/compare/0.1.3-GTNH...0.2.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OpenSecurity/compare/1.0.120-GTNH...1.1.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/OverloadedArmorBar/compare/1.0.3...1.1.0

# Updated PersonalSpace (1.0.28@Side.BOTH --> 1.0.30@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/PersonalSpace/compare/1.0.28...1.0.30
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Player-API/compare/1.4.3...1.4.4

# Updated ProjectBlue (1.1.12-GTNH@Side.BOTH --> 1.2.0-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ProjectBlue/compare/1.1.12-GTNH...1.2.0-GTNH
...
# Updated Railcraft (9.15.3@Side.BOTH --> 9.15.8@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Railcraft/compare/9.15.3...9.15.8
>## What's Changed
> * Fix lapo loader upgrade name by @chochem in https://github.com/GTNewHorizons/Railcraft/pull/58 (9.15.8)
> * Fix golden ticket not saving nbt by @Lyfts in https://github.com/GTNewHorizons/Railcraft/pull/57 (9.15.7)
...
# Updated Random-Things (2.4.6@Side.BOTH --> 2.5.3@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Random-Things/compare/2.4.5...2.5.3
>## What's Changed
> * Thaumcraft trees fast leaf decay fix by @HoleFish in https://github.com/GTNewHorizons/Random-Things/pull/6 (2.5.3)
> * Allow planting plains-type plants on tilled or untilled fertilized dirt by @Majora320 in https://github.com/GTNewHorizons/Random-Things/pull/5 (2.5.2)
...
**Full Changelog**: https://github.com/GTNewHorizons/RemoteIO/compare/2.4.8...2.5.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Roguelike-Dungeons/compare/1.5.3-GTNH...1.6.0-GTNH

# Updated SC2 (2.0.2@Side.BOTH --> 2.1.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/SC2/compare/2.0.2...2.1.1
>## What's Changed
> * Fix cargo manager slot handling by @Lyfts in https://github.com/GTNewHorizons/SC2/pull/5 (2.1.1)
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/SC2/pull/4 (2.1.0)
>

# Updated SGCraft (1.3.13-GTNH@Side.BOTH --> 1.4.4-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/SGCraft/compare/1.3.13-GTNH...1.4.4-GTNH
>## What's Changed
> * Fix the stargate improperly loading and unloading by @GregtechNewHorizons in https://github.com/GTNewHorizons/SGCraft/pull/18 (1.4.4-GTNH)
...
# Updated Schematica (1.9.4-GTNH@Side.CLIENT --> 1.11.1-GTNH@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Schematica/compare/1.9.4-GTNH...1.11.1-GTNH
>## What's Changed
...
# New Mod - ServerUtilities (2.0.35@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ServerUtilities/commits/2.0.35
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Share-Where-I-am/compare/2.0.2...2.1.1
>## What's Changed
> * Use proper Tags class by @glowredman in https://github.com/GTNewHorizons/Share-Where-I-am/pull/4 (2.1.0)
>

# Updated SleepingBags (0.1.4@Side.BOTH --> 0.2.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/SleepingBags/compare/0.1.4...0.2.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/SpecialMobs/compare/3.4.3...3.5.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/SpiceOfLife/compare/2.1.1-carrot...2.1.7-carrot
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Steve-s-Factory-Manager/compare/1.1.7-GTNH...1.2.3-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StevesAddons/compare/0.10.27...0.12.3
>## What's Changed
...
# Updated StorageDrawers (1.12.2-GTNH@Side.BOTH --> 1.13.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers/compare/1.12.2-GTNH...1.13.5-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers-BiomesOPlenty/compare/1.11.17-GTNH...1.12.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers-Forestry/compare/1.11.17-GTNH...1.12.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers-Misc/compare/1.11.18-GTNH...1.12.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StorageDrawers-Natura/compare/1.11.17-GTNH...1.12.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/StructureCompat/compare/0.4.0...0.5.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/StructureCompat/pull/2 (0.5.0)
>

# Updated StructureLib (1.2.9@Side.BOTH --> 1.3.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/StructureLib/compare/1.2.9...1.3.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Super-TiC/compare/1.2.5...1.3.0
>## What's Changed
...
# Updated TCNEIAdditions (1.2.2@Side.BOTH --> 1.3.6@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/TCNEIAdditions/compare/1.2.2...1.3.6
>## What's Changed
> * Workaround for cycled ingredients in infusion recipes by @miozune in https://github.com/GTNewHorizons/TCNEIAdditions/pull/25 (1.3.6)
...
**Full Changelog**: https://github.com/GTNewHorizons/TCNodeTracker/compare/1.1.7...1.2.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/TX-Loader/compare/1.6.3...1.7.0

# Updated Tainted-Magic (7.6.3-GTNH@Side.BOTH --> 7.6.4-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Tainted-Magic/compare/7.6.3-GTNH...7.6.4-GTNH
>## What's Changed
> * Fix broken mod by @chochem in https://github.com/GTNewHorizons/Tainted-Magic/pull/20 (7.6.4-GTNH)
>

# Updated TecTech (5.3.23@Side.BOTH --> 5.3.45@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/TecTech/compare/5.3.23...5.3.45
>## What's Changed
...
> * Don't load godforge  by @GDCloudstrike in https://github.com/GTNewHorizons/TecTech/pull/278 (5.3.44)
> * Fix EoH NPE by @GDCloudstrike in https://github.com/GTNewHorizons/TecTech/pull/277 (5.3.43)
> * Fix memory leak by tesla, but problem still exists when using tesla cover. by @koiNoCirculation in https://github.com/GTNewHorizons/TecTech/pull/275 (5.3.42)
> * Fix predetermined eoh outputs showing on scanner info by @GDCloudstrike in https://github.com/GTNewHorizons/TecTech/pull/276 (5.3.42)
...
# Updated ThaumicBases (1.5.6@Side.BOTH --> 1.6.7@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBases/compare/1.5.6...1.6.7
>## What's Changed
...
> * Crop cleanup and automation streamlining. by @C0bra5 in https://github.com/GTNewHorizons/ThaumicBases/pull/30 (1.6.4)
> * Move vis orbs from getDrops to onBlockHarvested by @Caedis in https://github.com/GTNewHorizons/ThaumicBases/pull/29 (1.6.3)
...
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicBoots/compare/1.1.0...1.2.1
>## What's Changed
...
# Updated ThaumicEnergistics (1.5.4-GTNH@Side.BOTH --> 1.6.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicEnergistics/compare/1.5.4-GTNH...1.6.5-GTNH
>## What's Changed
> * Make distillation pattern can handle larger pattern by @MCTBL in https://github.com/GTNewHorizons/ThaumicEnergistics/pull/62 (1.6.5-GTNH)
...
# Updated ThaumicHorizons (1.4.2@Side.BOTH --> 1.5.3@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicHorizons/compare/1.4.1...1.5.3
>## What's Changed
> * fix for gt6 by @Alastors in https://github.com/GTNewHorizons/ThaumicHorizons/pull/67 (1.5.3)
> * Update BS by @mitchej123 in https://github.com/GTNewHorizons/ThaumicHorizons/pull/66 (1.5.2)
> * Correct name application for Nightmare by @bombcar in https://github.com/GTNewHorizons/ThaumicHorizons/pull/62 (1.5.0)
>

# Updated ThaumicInventoryScanning (1.0.12-GTNH@Side.BOTH --> 1.1.4-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicInventoryScanning/compare/1.0.12-GTNH...1.1.4-GTNH
>## What's Changed
...
# Updated ThaumicTinkerer (2.8.5@Side.BOTH --> 2.9.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ThaumicTinkerer/compare/2.8.5...2.9.4
>## What's Changed
> * Use a more specific oredict for magic infused crop by @chochem in https://github.com/GTNewHorizons/ThaumicTinkerer/pull/39 (2.9.4)
...
# Updated Thaumic_Exploration (1.2.0-GTNH@Side.BOTH --> 1.2.5-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Thaumic_Exploration/compare/1.2.0-GTNH...1.2.5-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/TiC-Tooltips/compare/1.3.0...1.3.1

# Updated TinkersConstruct (1.10.13-GTNH@Side.BOTH --> 1.11.15-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/TinkersConstruct/compare/1.10.12-GTNH...1.11.15-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/TinkersMechworks/compare/0.3.0...0.3.1
...
**Full Changelog**: https://github.com/GTNewHorizons/ToroHealth/compare/1.0.3...1.1.0

# Updated Translocators (1.1.2.21@Side.BOTH --> 1.2.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Translocators/compare/1.1.2.21...1.2.1
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Universal-Singularities/compare/8.6.7...8.7.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/Universal-Singularities/pull/9 (8.7.0)
>

# Updated VisualProspecting (1.2.1@Side.BOTH --> 1.2.11@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/VisualProspecting/compare/1.2.1...1.2.11
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/WAILAPlugins/compare/0.3.0...0.4.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/WAWLA/compare/1.1.3-GTNH...1.2.0-GTNH
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/WAWLA/pull/5 (1.2.0-GTNH)
>

# Updated WailaHarvestability (1.1.10-GTNH@Side.BOTH --> 1.2.1-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/WailaHarvestability/compare/1.1.10-GTNH...1.2.1-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/WanionLib/compare/1.8.4...1.9.0
>## What's Changed
> * [bs] spotless apply for jenkins by @bombcar in https://github.com/GTNewHorizons/WanionLib/pull/2 (1.9.0)
>

# Updated WarpTheory (1.2.17-GTNH@Side.BOTH --> 1.3.7-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/WarpTheory/compare/1.2.16-GTNH...1.3.7-GTNH
>## What's Changed
...
# Updated WirelessCraftingTerminal (1.10.1@Side.BOTH --> 1.11.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/WirelessCraftingTerminal/compare/1.10.1...1.11.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/WirelessRedstone-CBE/compare/1.4.8...1.5.0
>## What's Changed
> * Fix CCRenderState for multithreading by @bombcar in https://github.com/GTNewHorizons/WirelessRedstone-CBE/pull/9 (1.5.0)
>

# Updated WitcheryExtras (1.1.14@Side.BOTH --> 1.2.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/WitcheryExtras/compare/1.1.14...1.2.2
>## What's Changed
> * Fix distillery inserting into output slot by @Lyfts in https://github.com/GTNewHorizons/WitcheryExtras/pull/21 (1.2.2)
...
# Updated WitchingGadgets (1.3.6-GTNH@Side.BOTH --> 1.4.3-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/WitchingGadgets/compare/1.3.6-GTNH...1.4.3-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/Yamcl/compare/0.5.86...0.6.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ae2stuff/compare/0.6.0-GTNH...0.7.0-GTNH

# Updated amunra (0.5.0@Side.BOTH --> 0.5.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/amunra/compare/0.5.0...0.5.1

# Updated bartworks (0.8.23@Side.BOTH --> 0.9.21@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/bartworks/compare/0.8.22...0.9.21
>## What's Changed
...
> * Numeric widget and localized number formatting. by @AbdielKavash in https://github.com/GTNewHorizons/bartworks/pull/2 (0.9.17)
> * Seems slightly more threadsafe by @mitchej123 in https://github.com/GTNewHorizons/bartworks/pull/1 (0.9.16)
...
**Full Changelog**: https://github.com/GTNewHorizons/bdlib/compare/1.9.8-GTNH...1.10.0-GTNH

# Updated gendustry (1.6.5.5-GTNH@Side.BOTH --> 1.7.0-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/gendustry/compare/1.6.5.5-GTNH...1.7.0-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/harvestcraft/compare/1.1.4-GTNH...1.1.10-GTNH
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/inventory-tweaks/compare/1.6.1...1.6.2
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/ironchest/compare/6.0.74...6.0.85
>## What's Changed
...
# Updated lwjgl3ify (1.5.7@Side.BOTH_JAVA9 --> 2.0.7@Side.BOTH_JAVA9)
**Full Changelog**: https://github.com/GTNewHorizons/lwjgl3ify/compare/1.5.7...2.0.7
>## What's Changed
...
# Updated nei-custom-diagram (1.5.14@Side.BOTH --> 1.5.17@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/nei-custom-diagram/compare/1.5.14...1.5.17
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/neiaddons/compare/1.13.0...1.15.0
>## What's Changed
...
**Full Changelog**: https://github.com/GTNewHorizons/thaumcraft-research-tweaks/compare/1.0.6...1.1.0

# Updated thaumicinsurgence (0.2.7@Side.BOTH --> 0.3.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/thaumicinsurgence/compare/0.2.7...0.3.1
>## What's Changed
...
# Updated twilightforest (2.5.1@Side.BOTH --> 2.5.23@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/twilightforest/compare/2.5.1...2.5.23
>## What's Changed
...
# Updated waila (1.6.5@Side.BOTH --> 1.7.3@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/waila/compare/1.6.5...1.7.3
>## What's Changed
...
# Credits
A special thank to @AbdielKavash ,@Ableytner ,@Alastors ,@AnrDaemon ,@ArtherCasan ,@AutumnalModding ,@C0bra5 ,@Caedis ,@Cardinalstars ,@Cleptomania ,@ColonelGerdauf ,@Connor-Colenso ,@CtrlAltDavid01 ,@Cyl18 ,@D-Cysteine ,@Drathonix ,@Dream-Master ,@Ethryan ,@EverNife ,@FalsePattern ,@Flanisch ,@GDCloudstrike ,@Ginsway ,@Gordon-Frohman ,@GregtechNewHorizons ,@Hikari1nVoid ,@HoleFish ,@IcaroKaue ,@ImgoodWK ,@KAMKEEL ,@Keridos ,@Kogepan229 ,@Laiff ,@Lyfts ,@Majora320 ,@MarloGr ,@MellowArpeggiation ,@Midnight145 ,@Mpcs ,@NealDeal34 ,@Noktuska ,@NotAPenguin0 ,@Nxer ,@OneEyeMaker ,@PT400C ,@Pelotrio ,@Pilzinsel64 ,@Pistonight ,@Pxldi ,@QuantumBlink1337 ,@Quantumlyy ,@Quetz4l ,@ReaganAR ,@RealSilverMoon ,@Reflex18 ,@RitumsC ,@Roadhog360 ,@S4mpsa ,@SKProCH ,@Steelux8 ,@TechnicianLP ,@ThePixelbrain ,@TheUnderTaker11 ,@TotallyNotOndre ,@Trinsdar ,@Tu0rp ,@UltraHex ,@XJIuPa ,@YannickMG ,@ZakBerkelaar ,@ah-OOG-ah ,@antropod ,@bearsdotzone ,@bertcardinaels ,@bessonowjaroslaw ,@bitonality ,@bombcar ,@boubou19 ,@chochem ,@claimg ,@connor135246 ,@cons-tan-tan ,@dahgul333 ,@dgealow ,@eigenraven ,@embeddedt ,@fluffle ,@ghostflyby ,@gitboy14 ,@github-actions ,@glowredman ,@jurrejelle ,@kamenskyi ,@kappa-maintainer ,@koiNoCirculation ,@konradmoesch ,@kuba6000 ,@kyoi-the-fox ,@leumasme ,@makamys ,@michaeldoylecs ,@miozune ,@mist475 ,@mitchej123 ,@mts2200 ,@nikita23830 ,@norbby42 ,@slprime ,@tomprince ,@tth05 ,@wahfl2, who contributed to this release!